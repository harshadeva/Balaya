            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <form action="{{route('upApprovedCanvassing')}}" method="GET">
                                <div class="row">
                                    {{ csrf_field() }}
                                                                ...
                                                                <td>
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            <a href="#"
                                                                               onclick="reject({{$canvassing->idcanvassing}})"
                    ...
                    success: function (data) {
                        ...
                        if (data.success != null) {
                            ...
                            notify({
                                ...
                                message: 'Canvassing rejected successfully.'
                            });
                            $('#'+id).remove();
                        }

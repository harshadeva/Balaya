                                        ...
                                        @if(isset($posts))
                                            @if($posts != null)
                                                @foreach($posts as $post)
                                                    <tr id="{{$post->idPost}}">
                                                        <td><a href="#" onclick="showPostContent({{$post->post_no}})"><p class="font-weight-bold">{{$post->title_en}}</p></a></td>
                                                        ...
                                                        <td nowrap="true">{!! \App\PostResponse::ETHNICITY_COUNT($post->idPost,3,isset($_REQUEST['start']) ? $_REQUEST['start'] : null,isset($_REQUEST['end']) ? $_REQUEST['end'] : null,isset($_REQUEST['village']) ? $_REQUEST['village'] : null,isset($_REQUEST['gramasewaDivision']) ? $_REQUEST['gramasewaDivision'] : null,isset($_REQUEST['pollingBooth']) ? $_REQUEST['pollingBooth'] : null,isset($_REQUEST['electionDivision']) ? $_REQUEST['electionDivision'] : null) !!}</td>
                                                        <td nowrap="true">{!! \App\PostResponse::RELIGION_COUNT($post->idPost,3,isset($_REQUEST['start']) ? $_REQUEST['start'] : null,isset($_REQUEST['end']) ? $_REQUEST['end'] : null,isset($_REQUEST['village']) ? $_REQUEST['village'] : null,isset($_REQUEST['gramasewaDivision']) ? $_REQUEST['gramasewaDivision'] : null,isset($_REQUEST['pollingBooth']) ? $_REQUEST['pollingBooth'] : null,isset($_REQUEST['electionDivision']) ? $_REQUEST['electionDivision'] : null) !!}</td>
                                                        <td nowrap="true">{!! \App\PostResponse::CAREER_COUNT($post->idPost,3,isset($_REQUEST['start']) ? $_REQUEST['start'] : null,isset($_REQUEST['end']) ? $_REQUEST['end'] : null,isset($_REQUEST['village']) ? $_REQUEST['village'] : null,isset($_REQUEST['gramasewaDivision']) ? $_REQUEST['gramasewaDivision'] : null,isset($_REQUEST['pollingBooth']) ? $_REQUEST['pollingBooth'] : null,isset($_REQUEST['electionDivision']) ? $_REQUEST['electionDivision'] : null) !!}</td>
                                                        <td nowrap="true">{!! \App\PostResponse::EDUCATION_COUNT($post->idPost,3,isset($_REQUEST['start']) ? $_REQUEST['start'] : null,isset($_REQUEST['end']) ? $_REQUEST['end'] : null,isset($_REQUEST['village']) ? $_REQUEST['village'] : null,isset($_REQUEST['gramasewaDivision']) ? $_REQUEST['gramasewaDivision'] : null,isset($_REQUEST['pollingBooth']) ? $_REQUEST['pollingBooth'] : null,isset($_REQUEST['electionDivision']) ? $_REQUEST['electionDivision'] : null) !!}</td>
                                                        <td nowrap="true">{!! \App\PostResponse::INCOME_COUNT($post->idPost,3,isset($_REQUEST['start']) ? $_REQUEST['start'] : null,isset($_REQUEST['end']) ? $_REQUEST['end'] : null,isset($_REQUEST['village']) ? $_REQUEST['village'] : null,isset($_REQUEST['gramasewaDivision']) ? $_REQUEST['gramasewaDivision'] : null,isset($_REQUEST['pollingBooth']) ? $_REQUEST['pollingBooth'] : null,isset($_REQUEST['electionDivision']) ? $_REQUEST['electionDivision'] : null) !!}</td>
                                                        <td nowrap="true">{!! \App\PostResponse::JOB_SECTOR_COUNT($post->idPost,3,isset($_REQUEST['start']) ? $_REQUEST['start'] : null,isset($_REQUEST['end']) ? $_REQUEST['end'] : null,isset($_REQUEST['village']) ? $_REQUEST['village'] : null,isset($_REQUEST['gramasewaDivision']) ? $_REQUEST['gramasewaDivision'] : null,isset($_REQUEST['pollingBooth']) ? $_REQUEST['pollingBooth'] : null,isset($_REQUEST['electionDivision']) ? $_REQUEST['electionDivision'] : null) !!}</td>
                                                        <td nowrap="true">{!! \App\PostResponse::GENDER($post->idPost,3,isset($_REQUEST['start']) ? $_REQUEST['start'] : null,isset($_REQUEST['end']) ? $_REQUEST['end'] : null,isset($_REQUEST['village']) ? $_REQUEST['village'] : null,isset($_REQUEST['gramasewaDivision']) ? $_REQUEST['gramasewaDivision'] : null,isset($_REQUEST['pollingBooth']) ? $_REQUEST['pollingBooth'] : null,isset($_REQUEST['electionDivision']) ? $_REQUEST['electionDivision'] : null) !!}</td>
                                                    </tr>
                                                @endforeach
                                            @endif
                                        @endif

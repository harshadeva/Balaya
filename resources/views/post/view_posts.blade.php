                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <p onclick="event.stopPropagation();" class="col-md-2">
                                                                            @if($post->status == 1)
                                                                                <span class="badge float-right badge-success">PUBLISHED</span>
                                                                            @elseif($post->status == 2)
                                                                                <span class="badge float-right badge-info">PENDING</span>
                                                                            @elseif($post->status == 0)
                                                                                <span class="badge float-right badge-danger">REJECTED</span>
                                                                            @endif
                                                                            </p>
                                                                    </div>
                                                                </div>

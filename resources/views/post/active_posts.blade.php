                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <p onclick="event.stopPropagation();" class="col-md-2">
                                                                            <button  onclick="event.preventDefault(); event.stopPropagation();rejectPost({{$post->idPost}})"  style="margin-top: -20px;font-weight: 600;height: 38px;width: 38px;" class="btn postButtons float-right btn-danger">X </button>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>

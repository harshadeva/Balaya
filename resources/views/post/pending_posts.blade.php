                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <p onclick="event.stopPropagation();" class="col-md-3">
                                                                            <button onclick="event.preventDefault(); event.stopPropagation();publishPost({{$post->idPost}})" style="margin-top: -20px;height: 40px;width: 40px;" class="btn ml-1 float-right postButtons btn-success"><em class="fa fa-check-square-o"></em> </button>
                                                                            <button  onclick="event.preventDefault(); event.stopPropagation();rejectPost({{$post->idPost}})"  style="margin-top: -20px;font-weight: 600;height: 40px;width: 40px;" class="btn float-right postButtons btn-danger"> X </button>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>

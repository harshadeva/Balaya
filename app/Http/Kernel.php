...
//            \App\Http\Middleware\AuthKey::class,
    ...
    protected $routeMiddleware = [
        ...
        'mediaStaff' => \App\Http\Middleware\MediaStaff::class,
        'mediaHead' => \App\Http\Middleware\MediaHead::class,
        'dataEntry' => \App\Http\Middleware\DataEntry::class,
        'officeAdmin' => \App\Http\Middleware\OfficeAdmin::class,
        'superAdmin' => \App\Http\Middleware\SuperAdmin::class,
        'analyzer' => \App\Http\Middleware\Analyzer::class,
        'onlyDataEntry' => \App\Http\Middleware\OnlyDataEntry::class,
        'postView' => \App\Http\Middleware\PostView::class,
        'hierarchy' => \App\Http\Middleware\Hierarchy::class,
